...
const Footer = () => {
  return (
    <footer className="py-8 border-t-8 border-[#2d2d2d]">
      <div className="w-[300px] xl:w-[1080px] md:w-[720px] sm:w-[600px] sm:px-8 mx-auto font-light text-white/80">
        <p className="my-6 text-sm sm:text-base">Questions? Call <span className="underline">000-800-919-1694</span></p>
        <div className='grid lg:grid-cols-4 grid-cols-2 sm:text-sm text-xs'>
