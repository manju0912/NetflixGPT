    ...
    <section className='w-full h-[100vh] bg-[url("/src/assets/banner.jpg")] bg-top relative'>
      ...
      <div className="absolute w-[60%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex justify-center items-end">
          ...
          <button type='submit' className='text-white bg-[#e50914] hover:bg-[#C2050E] transition ease-linear border border-1 border-white/70 py-[10px] px-[24px] rounded-r-full font-medium' onSubmit={(e) => e.preventDefault()} onClick={handleClaudeSearchClick}><IoSearch className="w-6 h-6" /></button>
        </div>
      </div>
    </section>
  )
